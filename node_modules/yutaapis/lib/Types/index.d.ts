...
import { AsciiResult, ClimaResult, EncurtalinkResult, FrasesAmorResult, TotextResult, MemeResult, type TraduzirLanguages, BuscarLocalResult, ShazamResult } from "./outros.js";
import { CardLevelUpOpts, PingOpts, CardPerfilOpts, ShipOpts, SaiuOpts, QcOpts, GoodbyeOpts } from './canvas.js';
...
export type PlaqParams = 'plaq1' | 'plaq2' | 'plaq3' | 'plaq4' | 'plaq5' | 'plaq6' | 'plaq7' | 'plaq8' | 'plaq9' | 'plaq10';
